...
public interface UserService {
    ...
    Optional<User> findByUsername(@NotEmpty(message = "Поле не должно быть пустым") String username);

    Optional<User> findByEmail(@NotEmpty(message = "Поле не должно быть пустым") String email);
