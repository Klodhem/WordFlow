...
public interface GroupService {
    ...
    boolean existsVideoInGroupForUser(long groupId, String videoId);

    ResourceRegion getVideoRegion(String videoId, long groupId, HttpHeaders headers);

    File getVttFileVideoGroup(String videoId, long groupId, String type);

    List<TranslateProposalDTO> getDictionaryVideoGroup(String videoId, long groupId);
}
