...
import git.klodhem.videoservice.exception.NonretryableException;
import git.klodhem.videoservice.exception.RetryableException;
...
public class KafkaConfig {
    ...
    ConsumerFactory<String, Object> consumerFactory() {
        ...
        config.put(JsonDeserializer.TRUSTED_PACKAGES, env.getProperty("spring.kafka.consumer.properties.json.trusted.packages"));
